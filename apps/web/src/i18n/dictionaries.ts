...
export const en: Dict = {
  ...
  'shop.sealButterfly': 'Butterfly',
  'shop.sealButterflyDesc': 'A butterfly perched on your mark, wings never still.',
  'shop.sealEye': 'Eye',
  'shop.sealEyeDesc': 'It watches from your mark. Blink and it blinks back.',
  'shop.sealColorButterfly': 'Butterfly colour',
  'shop.sealColorEye': 'Eye colour',
...
export const ru: Dict = {
  ...
  'shop.sealButterfly': 'Бабочка',
  'shop.sealButterflyDesc': 'Бабочка присела на твою печать — крылья не знают покоя.',
  'shop.sealEye': 'Глаз',
  'shop.sealEyeDesc': 'Он смотрит с твоей печати. Моргни — и он моргнёт в ответ.',
  'shop.sealColorButterfly': 'Цвет бабочки',
  'shop.sealColorEye': 'Цвет глаза',
...
export const uk: Dict = {
  ...
  'shop.sealButterfly': 'Метелик',
  'shop.sealButterflyDesc': 'Метелик присів на твою печатку — крила не знають спокою.',
  'shop.sealEye': 'Око',
  'shop.sealEyeDesc': 'Воно дивиться з твоєї печатки. Кліпни — і воно кліпне у відповідь.',
  'shop.sealColorButterfly': 'Колір метелика',
  'shop.sealColorEye': 'Колір ока',

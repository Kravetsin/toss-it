...
export const en: Dict = {
  ...
  'dash.mediaKeysArmed': 'Media keys control the music (next/prev/pause)',
  'dash.mediaKeysWaiting': 'Click anywhere on the page to enable media keys',
...
export const ru: Dict = {
  ...
  'dash.mediaKeysArmed': 'Медиа-клавиши управляют музыкой (след/пред/пауза)',
  'dash.mediaKeysWaiting': 'Кликни в любом месте страницы, чтобы включить медиа-клавиши',
...
export const uk: Dict = {
  ...
  'dash.mediaKeysArmed': 'Медіа-клавіші керують музикою (наст/попер/пауза)',
  'dash.mediaKeysWaiting': 'Клікни будь-де на сторінці, щоб увімкнути медіа-клавіші',

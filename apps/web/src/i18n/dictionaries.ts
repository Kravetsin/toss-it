...
export const en: Dict = {
  ...
  'shop.cardBubblesDesc': 'Everything light eventually bursts.',
  'shop.cardWisp': 'Will-o’-the-wisp',
  'shop.cardWispDesc': 'Chase the light, and it’s already elsewhere.',
  'shop.cardRunes': 'Runes',
  'shop.cardRunesDesc': 'It was written before it was read.',
  'shop.cardWeb': 'Web',
  'shop.cardWebDesc': 'Something bright was caught in it.',
...
export const ru: Dict = {
  ...
  'shop.cardBubblesDesc': 'Всё лёгкое рано или поздно лопается.',
  'shop.cardWisp': 'Блуждающий огонёк',
  'shop.cardWispDesc': 'Идёшь на свет — а он уже в другом месте.',
  'shop.cardRunes': 'Руны',
  'shop.cardRunesDesc': 'Написано было раньше, чем прочитано.',
  'shop.cardWeb': 'Паутина',
  'shop.cardWebDesc': 'В неё попалось что-то светящееся.',
...
export const uk: Dict = {
  ...
  'shop.cardBubblesDesc': 'Усе легке рано чи пізно лопається.',
  'shop.cardWisp': 'Блукаючий вогник',
  'shop.cardWispDesc': 'Ідеш на світло — а воно вже в іншому місці.',
  'shop.cardRunes': 'Руни',
  'shop.cardRunesDesc': 'Написано було раніше, ніж прочитано.',
  'shop.cardWeb': 'Павутина',
  'shop.cardWebDesc': 'У неї впіймалося щось світне.',

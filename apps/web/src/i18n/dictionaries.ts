...
export const en: Dict = {
  ...
  'shop.frameVineSprout': 'Shoots',
  'shop.frameVineSproutDesc': 'Something took root here. It has not decided what yet.',
  'shop.frameVine': 'Vine',
  'shop.frameVineDesc': 'It grew here while you were watching.',
  'shop.frameVineBloom': 'Vine in bloom',
  'shop.frameVineBloomDesc': 'Stay long enough and even the patient things open up.',
...
export const ru: Dict = {
  ...
  'shop.frameVineSprout': 'Побеги',
  'shop.frameVineSproutDesc': 'Здесь что-то пустило корни. Ещё не решило, что именно.',
  'shop.frameVine': 'Лоза',
  'shop.frameVineDesc': 'Она выросла здесь, пока ты смотрел.',
  'shop.frameVineBloom': 'Лоза в цвету',
  'shop.frameVineBloomDesc': 'Останься подольше — и даже терпеливое раскрывается.',
...
export const uk: Dict = {
  ...
  'shop.frameVineSprout': 'Пагони',
  'shop.frameVineSproutDesc': 'Тут щось пустило коріння. Ще не вирішило, що саме.',
  'shop.frameVine': 'Лоза',
  'shop.frameVineDesc': 'Вона виросла тут, поки ти дивився.',
  'shop.frameVineBloom': 'Лоза у цвіту',
  'shop.frameVineBloomDesc': 'Залишся довше — і навіть терпляче розкривається.',

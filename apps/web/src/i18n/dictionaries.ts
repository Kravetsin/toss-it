...
export const en: Dict = {
  ...
  'music.emptyCta': 'Import a playlist or add tracks',
  'music.importLabel': 'Import a YouTube playlist (replaces the list)',
  'music.import': 'Import',
  'music.importConfirm': 'Replace the current list with this playlist?',
  'music.imported': 'Playlist imported',
  'music.addLabel': 'Add a track by link',
  'music.add': 'Add',
  'music.added': 'Track added',
  'music.shuffle': 'Shuffle playback',
  'music.empty': 'The list is empty. Import a playlist or add tracks above.',
  'music.up': 'Move up',
  'music.down': 'Move down',
  'music.remove': 'Remove',
  ...
  'dash.bgMusic': 'Background music',
  'dash.bgMusicNote':
    'A YouTube playlist plays between posts and dips while one is on screen. Use copyright-free music (e.g. NCS) — streams mute infringing audio.',
  'dash.bgMusicPlaylist': 'YouTube playlist link',
  'dash.bgMusicVolume': 'Music volume: {n}',
  'dash.bgMusicHidden': 'Hide the player in OBS (audio only)',
...
export const ru: Dict = {
  ...
  'music.emptyCta': 'Импортируй плейлист или добавь треки',
  'music.importLabel': 'Импорт плейлиста YouTube (заменит список)',
  'music.import': 'Импорт',
  'music.importConfirm': 'Заменить текущий список этим плейлистом?',
  'music.imported': 'Плейлист импортирован',
  'music.addLabel': 'Добавить трек по ссылке',
  'music.add': 'Добавить',
  'music.added': 'Трек добавлен',
  'music.shuffle': 'Перемешивать воспроизведение',
  'music.empty': 'Список пуст. Импортируй плейлист или добавь треки выше.',
  'music.up': 'Вверх',
  'music.down': 'Вниз',
  ...
  'dash.bgMusic': 'Фоновая музыка',
  'dash.bgMusicNote':
    'Плейлист с YouTube играет между постами и приглушается, пока пост на экране. Используй музыку без авторских прав (например, NCS) — стримы глушат аудио с нарушением.',
  'dash.bgMusicPlaylist': 'Ссылка на плейлист YouTube',
  'dash.bgMusicVolume': 'Громкость музыки: {n}',
  'dash.bgMusicHidden': 'Скрыть плеер в OBS (только звук)',
...
export const uk: Dict = {
  ...
  'music.emptyCta': 'Імпортуй плейлист або додай треки',
  'music.importLabel': 'Імпорт плейлиста YouTube (замінить список)',
  'music.import': 'Імпорт',
  'music.importConfirm': 'Замінити поточний список цим плейлистом?',
  'music.imported': 'Плейлист імпортовано',
  'music.addLabel': 'Додати трек за посиланням',
  'music.add': 'Додати',
  'music.added': 'Трек додано',
  'music.shuffle': 'Перемішувати відтворення',
  'music.empty': 'Список порожній. Імпортуй плейлист або додай треки вище.',
  'music.up': 'Вгору',
  'music.down': 'Вниз',
  ...
  'dash.bgMusic': 'Фонова музика',
  'dash.bgMusicNote':
    'Плейлист з YouTube грає між постами й приглушується, поки пост на екрані. Використовуй музику без авторських прав (наприклад, NCS) — стріми глушать аудіо з порушенням.',
  'dash.bgMusicPlaylist': 'Посилання на плейлист YouTube',
  'dash.bgMusicVolume': 'Гучність музики: {n}',
  'dash.bgMusicHidden': 'Сховати плеєр в OBS (лише звук)',

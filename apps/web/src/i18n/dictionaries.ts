...
export const en: Dict = {
  ...
  'shop.entrancePortalDesc': "It didn't come in. It came through.",
  'shop.entrancePortalColor': 'Portal color',
  'shop.entrancePortalColorDesc': 'Every world burns a different color at its edge.',
  ...
  'theme.galaxyShow': 'Galaxy background',
  'theme.galaxyHint':
    'A spiral galaxy behind your channel page. Appears once {n} of your submissions have aired on stream.',
  'achv.title': 'Achievements',
  'achv.subtitle': 'Rewards your channel earns through activity — never for sale.',
  'achv.nebulaName': 'Home Galaxy',
  'achv.nebulaDesc':
    'A barred spiral turning slowly behind your channel page — every viewer arrives inside it.',
...
export const ru: Dict = {
  ...
  'shop.entrancePortalDesc': 'Оно не вошло. Оно прошло насквозь.',
  'shop.entrancePortalColor': 'Цвет портала',
  'shop.entrancePortalColorDesc': 'Каждый мир горит своим цветом по краю.',
  ...
  'theme.galaxyShow': 'Галактический фон',
  'theme.galaxyHint':
    'Спиральная галактика за страницей канала. Появляется, когда на стриме показано {n} ваших отправок.',
  'achv.title': 'Достижения',
  'achv.subtitle': 'Награды, которые канал зарабатывает активностью, — их нельзя купить.',
  'achv.nebulaName': 'Родная галактика',
  'achv.nebulaDesc':
    'Барированная спираль медленно вращается за страницей канала — каждый зритель попадает прямо внутрь неё.',
...
export const uk: Dict = {
  ...
  'shop.entrancePortal': 'Портал',
  'shop.entrancePortalDesc': 'Воно не увійшло. Воно пройшло наскрізь.',
  'shop.entrancePortalColor': 'Колір порталу',
  'shop.entrancePortalColorDesc': 'Кожен світ горить своїм кольором по краю.',
  ...
  'theme.galaxyShow': 'Галактичний фон',
  'theme.galaxyHint':
    'Спіральна галактика за сторінкою каналу. З’являється, коли на стрімі показано {n} ваших надсилань.',
  'achv.title': 'Досягнення',
  'achv.subtitle': 'Нагороди, які канал заробляє активністю, — їх не можна купити.',
  'achv.nebulaName': 'Рідна галактика',
  'achv.nebulaDesc':
    'Барована спіраль повільно обертається за сторінкою каналу — кожен глядач потрапляє прямо всередину неї.',

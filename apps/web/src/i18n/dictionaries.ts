...
export const en: Dict = {
  ...
  'shop.sealMorse': 'Morse',
  'shop.sealMorseDesc': 'Dots and dashes running the loop. Every mark is a message you sent.',
  'shop.sealEye': 'Eye',
  'shop.sealEyeDesc': 'It watches from your mark. Blink and it blinks back.',
  'shop.sealColorMorse': 'Morse colour',
...
export const ru: Dict = {
  ...
  'shop.sealMorse': 'Морзянка',
  'shop.sealMorseDesc': 'Точки и тире бегут по кольцу. Каждая метка — твоё сообщение.',
  'shop.sealEye': 'Глаз',
  'shop.sealEyeDesc': 'Он смотрит с твоей печати. Моргни — и он моргнёт в ответ.',
  'shop.sealColorMorse': 'Цвет морзянки',
...
export const uk: Dict = {
  ...
  'shop.sealMorse': 'Морзянка',
  'shop.sealMorseDesc': 'Крапки й тире біжать по кільцю. Кожна позначка — твоє повідомлення.',
  'shop.sealEye': 'Око',
  'shop.sealEyeDesc': 'Воно дивиться з твоєї печатки. Кліпни — і воно кліпне у відповідь.',
  'shop.sealColorMorse': 'Колір морзянки',

...
export const en: Dict = {
  ...
  'dash.donatelloConnected': 'Connected as {name}',
  'dash.donatelloTokenPlaceholder': 'Donatello API token',
  'dash.donatelloHint': 'Donatello → API page → copy the token',
  'dash.donatelloInvalid': 'Invalid token — check it on the Donatello API page',
...
export const ru: Dict = {
  ...
  'dash.donatelloConnected': 'Подключено как {name}',
  'dash.donatelloTokenPlaceholder': 'API-токен Donatello',
  'dash.donatelloHint': 'Donatello → страница API → скопируй токен',
  'dash.donatelloInvalid': 'Неверный токен — проверь на странице API Donatello',

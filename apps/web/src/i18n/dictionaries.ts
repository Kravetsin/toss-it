...
export const en: Dict = {
  ...
  'shop.nickPulseDesc': 'A breathing glow around the name in the nick color.',
  'shop.cardEmbers': 'Embers',
  'shop.cardEmbersDesc': 'Fiery sparks crackling up the card, burning out as they fly.',
  'shop.cardRain': 'Rain',
...
export const ru: Dict = {
  ...
  'shop.nickPulseDesc': 'Дышащее свечение вокруг ника в цвете ника.',
  'shop.cardEmbers': 'Искры',
  'shop.cardEmbersDesc': 'Огненные искры трещат вверх по карточке, сгорая на лету.',
  'shop.cardRain': 'Дождь',
...
export const uk: Dict = {
  ...
  'shop.nickPulse': 'Пульс',
  'shop.nickPulseDesc': 'Живе світіння навколо ніка в кольорі ніка.',
  'shop.cardEmbers': 'Іскри',
  'shop.cardEmbersDesc': 'Вогняні іскри тріщать угору карткою, згоряючи на льоту.',
  'shop.cardRain': 'Дощ',

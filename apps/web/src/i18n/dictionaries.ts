...
export const en: Dict = {
  ...
  'bg.none': 'None',
  'bg.nebula': 'Galaxy',
  'bg.lockedHint': 'Unlocks once {n} of your submissions have aired on stream.',
...
export const ru: Dict = {
  ...
  'bg.none': 'Нет',
  'bg.nebula': 'Галактика',
  'bg.lockedHint': 'Откроется, когда на стриме покажут {n} ваших отправок.',
...
export const uk: Dict = {
  ...
  'bg.none': 'Немає',
  'bg.nebula': 'Галактика',
  'bg.lockedHint': 'Відкриється, коли на стрімі покажуть {n} ваших надсилань.',

...
export const en: Dict = {
  ...
  'shop.cardHandprints': 'Handprints',
  'shop.cardHandprintsDesc': 'Someone keeps leaning on the other side.',
...
export const ru: Dict = {
  ...
  'shop.cardHandprints': 'Отпечатки',
  'shop.cardHandprintsDesc': 'Кто-то всё прижимается с той стороны.',
...
export const uk: Dict = {
  ...
  'shop.cardHandprints': 'Відбитки',
  'shop.cardHandprintsDesc': 'Хтось усе тулиться з того боку.',

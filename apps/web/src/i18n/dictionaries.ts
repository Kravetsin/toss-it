...
export const en: Dict = {
  ...
  'shop.entrancePortalDesc': 'A doorway opens. The message steps through.',
  'shop.entrancePortalColor': 'Portal color',
  'shop.entrancePortalColorDesc': 'Tint the portal sparks any color you like.',
...
export const ru: Dict = {
  ...
  'shop.entrancePortalDesc': 'Открывается портал — и сообщение выходит из него.',
  'shop.entrancePortalColor': 'Цвет портала',
  'shop.entrancePortalColorDesc': 'Перекрась искры портала в любой цвет.',
  'shop.catNick': 'Ник',
...
export const uk: Dict = {
  ...
  'shop.entrancePortal': 'Портал',
  'shop.entrancePortalDesc': 'Відкривається портал — і повідомлення виходить із нього.',
  'shop.entrancePortalColor': 'Колір порталу',
  'shop.entrancePortalColorDesc': 'Перефарбуй іскри порталу в будь-який колір.',
  'shop.catNick': 'Нік',
  'shop.catCard': 'Картка',

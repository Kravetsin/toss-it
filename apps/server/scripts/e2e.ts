...
// --- 12b. Отдельный лимит для аудио: видео=5с, аудио=3с, и аудио режется по своему ---
...
const audio = await upload(streamerCookie, 'scripts/fixtures/audio10.mp3', 'audio/mpeg', 'audio10.mp3');

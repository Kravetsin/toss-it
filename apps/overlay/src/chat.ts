...
if (DEMO) {
  ...
  const demo: ChatOverlayMessage[] = [
    ...
    },
    {
      ...
      name: 'polarnight',
      twitchColor: '#b18cff',
      cosmetics: { cardEffect: 'card-aurora' },
      isFounder: false,
      level: 6,
      fragments: [{ type: 'text', text: 'у нас такое небо сегодня' }],
    },
    {
      id: '5j',
      userId: 'u5j',
      ...
      twitchColor: '#ffd166',
      cosmetics: {
        cardEffect: 'card-ripples',
        cardEffectColors: { 'card-ripples': '#ffd166' },
      },
      isFounder: false,
      level: 8,
      fragments: [{ type: 'text', text: 'тихо, слышно каждую каплю' }],
    },
    {
      id: '5k',
      userId: 'u5k',
      name: 'gromfest',
      twitchColor: '#ffd166',
      cosmetics: { cardEffect: 'card-fireworks' },
      isFounder: false,
      level: 9,
      fragments: [{ type: 'text', text: 'за это стоит поднять небо' }],
    },
    {
      id: '5l',
      userId: 'u5l',
      ...
      twitchColor: '#b18cff',
      cosmetics: {
        cardEffect: 'card-flock',
        cardEffectColors: { 'card-flock': '#b18cff' },
      },
      isFounder: false,
      level: 7,
      fragments: [{ type: 'text', text: 'мы поворачиваем все разом' }],
    },
    {
      id: '5m',
      userId: 'u5m',
      name: 'meadowlark',
      twitchColor: '#d6ffaa',
      cosmetics: { cardEffect: 'card-fireflies' },
      isFounder: false,
      level: 5,
      fragments: [{ type: 'text', text: 'жди третьей вспышки' }],
    },
    {
      id: '5n',
      userId: 'u5n',
    ...
    },
    {
      ...
      name: 'coldbreath',
      twitchColor: '#cfe9ff',
      cosmetics: { cardEffect: 'card-frost' },
      isFounder: false,
      level: 6,

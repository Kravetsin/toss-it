 ...
 *
 * No colour upgrade: the orange-and-white patchwork IS what makes them koi.
 */
...
const FISH: Fish[] = [
  { fx: 1, fy: 2, phx: 0.9, phy: 1.3, dir: 1, body: '#f2ede2', patch: '#f2a65a', ringAt: 2.5 },
  { fx: 2, fy: 1, phx: 4.2, phy: 0.6, dir: -1, body: '#f2b06a', patch: '#fdf6ea', ringAt: 9.5 },
];
...
function render(layer: HTMLElement): (() => void) | void {
  ...
  return mountScene(layer, 'card-koi', paint, { loopMs: LOOP, stillMs: 2000, maxLive: 8 });
}
